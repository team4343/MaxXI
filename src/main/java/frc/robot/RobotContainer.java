...
public class RobotContainer {
    ...
    public Command getAutonomousCommand() {
        ...
        PathPlannerTrajectory traj1 = PathPlanner.generatePath(new PathConstraints(4, .5),
                new PathPoint(new Translation2d(1.0, 1.0), Rotation2d.fromDegrees(0)), // position,
                                                                                       // heading
                new PathPoint(new Translation2d(3.0, 3.0), Rotation2d.fromDegrees(45)), // position,
                                                                                        // heading
                new PathPoint(new Translation2d(-3.0, -3.0), Rotation2d.fromDegrees(0)) // position,
                                                                                        // heading
        );
