...
public final class DriveConstants {
    ...
    public static final double X_RATE_LIMITER_MANUAL = 1.5;
    public static final double Y_RATE_LIMITER_MANUAL = 1.5;
    public static final double R_RATE_LIMITER_MANUAL = 3.0;
